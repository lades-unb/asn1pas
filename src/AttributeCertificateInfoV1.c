...
static asn_TYPE_tag2member_t asn_MAP_subject_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* baseCertificateID at 2042 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* subjectName at 2044 */
};
...
static asn_SET_OF_specifics_t asn_SPC_attributes_specs_10 = {
	sizeof(struct attributes_v2),
	offsetof(struct attributes_v2, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_AttributeCertificateInfoV1_1[] = {
	{ ATF_NOFLAGS, 1, offsetof(struct AttributeCertificateInfoV1, version),
...
static asn_TYPE_tag2member_t asn_MAP_AttributeCertificateInfoV1_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 0, 0, 1 }, /* version at 2040 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 4, -1, 0 }, /* serialNumber at 2048 */
    { (ASN_TAG_CLASS_UNIVERSAL | (3 << 2)), 7, 0, 0 }, /* issuerUniqueID at 2051 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 2, 0, 4 }, /* issuer at 2046 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 3, -1, 3 }, /* signature at 2047 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 5, -2, 2 }, /* attCertValidityPeriod at 2049 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 6, -3, 1 }, /* attributes at 2050 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 8, -4, 0 }, /* extensions at 2052 */
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 1, 0, 0 }, /* baseCertificateID at 2042 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* subjectName at 2044 */
};
