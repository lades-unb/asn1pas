...
static asn_TYPE_tag2member_t asn_MAP_subject_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* baseCertificateID at 2077 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* subjectName at 2081 */
};
...
static asn_TYPE_tag2member_t asn_MAP_AttributeCertificateInfoV1_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 0, 0, 1 }, /* version at 2075 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 4, -1, 0 }, /* serialNumber at 2084 */
    { (ASN_TAG_CLASS_UNIVERSAL | (3 << 2)), 7, 0, 0 }, /* issuerUniqueID at 2087 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 2, 0, 4 }, /* issuer at 2082 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 3, -1, 3 }, /* signature at 2083 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 5, -2, 2 }, /* attCertValidityPeriod at 2085 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 6, -3, 1 }, /* attributes at 2086 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 8, -4, 0 }, /* extensions at 2088 */
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 1, 0, 0 }, /* baseCertificateID at 2077 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* subjectName at 2081 */
};
