...
static asn_TYPE_tag2member_t asn_MAP_AttCertIssuer_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0, 0 }, /* v1Form at 2184 */
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 1, 0, 0 } /* v2Form at 2189 */
};
