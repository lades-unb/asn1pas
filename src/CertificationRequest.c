...
static asn_TYPE_member_t asn_MBR_CertificationRequest_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CertificationRequest, certificationRequestInfo),
		...
		0,
		&asn_DEF_CertificationRequestInfo,
...
static ber_tlv_tag_t asn_DEF_CertificationRequest_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_CertificationRequest_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (3 << 2)), 2, 0, 0 }, /* signature at 2361 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0, 1 }, /* certificationRequestInfo at 2358 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 1, -1, 0 } /* signatureAlgorithm at 2359 */
};
...
asn_TYPE_descriptor_t asn_DEF_CertificationRequest = {
	...
	asn_DEF_CertificationRequest_tags_1,
	sizeof(asn_DEF_CertificationRequest_tags_1)
		/sizeof(asn_DEF_CertificationRequest_tags_1[0]), /* 1 */
	asn_DEF_CertificationRequest_tags_1,	/* Same as above */
	sizeof(asn_DEF_CertificationRequest_tags_1)
		/sizeof(asn_DEF_CertificationRequest_tags_1[0]), /* 1 */
