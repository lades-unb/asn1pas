...
static asn_TYPE_tag2member_t asn_MAP_KeyAgreeRecipientIdentifier_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0, 0 }, /* issuerAndSerialNumber at 1817 */
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 1, 0, 0 } /* rKeyId at 1818 */
};
