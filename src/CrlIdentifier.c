...
static ber_tlv_tag_t asn_DEF_CrlIdentifier_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_CrlIdentifier_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 2, 0, 0 }, /* crlNumber at 269 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0, 0 }, /* rdnSequence at 543 */
    { (ASN_TAG_CLASS_UNIVERSAL | (23 << 2)), 1, 0, 0 } /* crlIssuedTime at 268 */
};
...
asn_TYPE_descriptor_t asn_DEF_CrlIdentifier = {
	"CrlIdentifier",
	"CrlIdentifier",
	SEQUENCE_free,
	SEQUENCE_print,
	...
	asn_DEF_CrlIdentifier_tags_1,
	sizeof(asn_DEF_CrlIdentifier_tags_1)
		/sizeof(asn_DEF_CrlIdentifier_tags_1[0]), /* 1 */
	asn_DEF_CrlIdentifier_tags_1,	/* Same as above */
	sizeof(asn_DEF_CrlIdentifier_tags_1)
		/sizeof(asn_DEF_CrlIdentifier_tags_1[0]), /* 1 */
