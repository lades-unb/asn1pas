...
static asn_TYPE_tag2member_t asn_MAP_OriginatorIdentifierOrKey_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0, 0 }, /* issuerAndSerialNumber at 1837 */
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 1, 0, 0 }, /* subjectKeyIdentifier at 1838 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 2, 0, 0 } /* originatorKey at 1839 */
};
...
asn_TYPE_descriptor_t asn_DEF_OriginatorIdentifierOrKey = {
