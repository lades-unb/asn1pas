...
static ber_tlv_tag_t asn_DEF_CompleteCertificateRefs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
...
asn_TYPE_descriptor_t asn_DEF_CompleteCertificateRefs = {
	...
	asn_DEF_CompleteCertificateRefs_tags_1,
	sizeof(asn_DEF_CompleteCertificateRefs_tags_1)
		/sizeof(asn_DEF_CompleteCertificateRefs_tags_1[0]), /* 1 */
	asn_DEF_CompleteCertificateRefs_tags_1,	/* Same as above */
	sizeof(asn_DEF_CompleteCertificateRefs_tags_1)
		/sizeof(asn_DEF_CompleteCertificateRefs_tags_1[0]), /* 1 */
