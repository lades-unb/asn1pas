...
static asn_TYPE_tag2member_t asn_MAP_CommitmentRule_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0, 0 }, /* selCommitmentTypes at 1039 */
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 1, 0, 0 }, /* signerAndVeriferRules at 1040 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 2, 0, 0 }, /* signingCertTrustCondition at 1041 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 3, 0, 0 }, /* timeStampTrustCondition at 1042 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 4, 0, 0 }, /* attributeTrustCondition at 1043 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 5, 0, 0 }, /* algorithmConstraintSet at 1044 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 6, 0, 0 } /* signPolExtensions at 1045 */
};
