...
static ber_tlv_tag_t asn_DEF_ocspResponses_tags_2[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
...
asn_TYPE_descriptor_t asn_DEF_ocspResponses_2 = {
	"ocspResponses",
	"ocspResponses",
	SEQUENCE_OF_free,
	SEQUENCE_OF_print,
	...
	asn_DEF_ocspResponses_tags_2,
	sizeof(asn_DEF_ocspResponses_tags_2)
		/sizeof(asn_DEF_ocspResponses_tags_2[0]), /* 1 */
	asn_DEF_ocspResponses_tags_2,	/* Same as above */
	sizeof(asn_DEF_ocspResponses_tags_2)
		/sizeof(asn_DEF_ocspResponses_tags_2[0]), /* 1 */
...
static ber_tlv_tag_t asn_DEF_OcspListID_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_OcspListID_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0, 0 } /* ocspResponses at 272 */
};
...
asn_TYPE_descriptor_t asn_DEF_OcspListID = {
	"OcspListID",
	"OcspListID",
	SEQUENCE_free,
	SEQUENCE_print,
	...
	0, 0,	/* No PER support, use "-gen-PER" to enable */
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_OcspListID_tags_1,
	sizeof(asn_DEF_OcspListID_tags_1)
		/sizeof(asn_DEF_OcspListID_tags_1[0]), /* 1 */
	asn_DEF_OcspListID_tags_1,	/* Same as above */
	sizeof(asn_DEF_OcspListID_tags_1)
		/sizeof(asn_DEF_OcspListID_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
