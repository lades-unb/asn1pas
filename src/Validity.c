...
static asn_TYPE_tag2member_t asn_MAP_Validity_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (23 << 2)), 0, 0, 1 }, /* utcTime at 593 */
    { (ASN_TAG_CLASS_UNIVERSAL | (23 << 2)), 1, -1, 0 }, /* utcTime at 593 */
    { (ASN_TAG_CLASS_UNIVERSAL | (24 << 2)), 0, 0, 1 }, /* generalTime at 594 */
    { (ASN_TAG_CLASS_UNIVERSAL | (24 << 2)), 1, -1, 0 } /* generalTime at 594 */
};
