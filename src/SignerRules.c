...
static asn_TYPE_tag2member_t asn_MAP_SignerRules_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (1 << 2)), 0, 0, 0 }, /* externalSignedData at 1055 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 1, 0, 1 }, /* mandatedSignedAttr at 1059 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 2, -1, 0 }, /* mandatedUnsignedAttr at 1061 */
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 3, 0, 0 }, /* mandatedCertificateRef at 1063 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 4, 0, 0 }, /* mandatedCertificateInfo at 1065 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 5, 0, 0 } /* signPolExtensions at 1068 */
};
