...
static asn_TYPE_tag2member_t asn_MAP_KEKRecipientInfo_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_UNIVERSAL | (4 << 2)), 3, 0, 0 }, /* encryptedKey at 1866 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 1, 0, 1 }, /* kekid at 1864 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 2, -1, 0 } /* keyEncryptionAlgorithm at 1865 */
};
