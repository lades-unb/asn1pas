...
static asn_TYPE_tag2member_t asn_MAP_CertificateChoices_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0, 0 }, /* certificate at 1902 */
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 1, 0, 0 }, /* extendedCertificate at 1903 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 2, 0, 0 }, /* v1AttrCert at 1904 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 3, 0, 0 }, /* v2AttrCert at 1905 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 4, 0, 0 } /* other at 1906 */
};
