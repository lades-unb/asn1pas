...
static asn_TYPE_tag2member_t asn_MAP_SignaturePolicy_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (4 << 2)), 2, 0, 0 }, /* signPolicyHash at 980 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0, 1 }, /* signPolicyHashAlg at 978 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 1, -1, 0 } /* signPolicyInfo at 979 */
};
