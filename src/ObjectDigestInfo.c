...
static asn_INTEGER_enum_map_t asn_MAP_digestedObjectType_value2enum_2[] = {
	{ 0,	9,	"publicKey" },
	{ 1,	13,	"publicKeyCert" },
	{ 2,	16,	"otherObjectTypes" }
};
static unsigned int asn_MAP_digestedObjectType_enum2value_2[] = {
...
static ber_tlv_tag_t asn_DEF_digestedObjectType_tags_2[] = {
...
static ber_tlv_tag_t asn_DEF_ObjectDigestInfo_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_ObjectDigestInfo_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (3 << 2)), 3, 0, 0 }, /* objectDigest at 2181 */
    { (ASN_TAG_CLASS_UNIVERSAL | (6 << 2)), 1, 0, 0 }, /* otherObjectTypeID at 2178 */
    { (ASN_TAG_CLASS_UNIVERSAL | (10 << 2)), 0, 0, 0 }, /* digestedObjectType at 2173 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 2, 0, 0 } /* digestAlgorithm at 2179 */
};
