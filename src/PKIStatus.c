...
static ber_tlv_tag_t asn_DEF_PKIStatus_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (2 << 2))
};
asn_TYPE_descriptor_t asn_DEF_PKIStatus = {
	"PKIStatus",
	"PKIStatus",
	PKIStatus_free,
	PKIStatus_print,
	...
	asn_DEF_PKIStatus_tags_1,
	sizeof(asn_DEF_PKIStatus_tags_1)
		/sizeof(asn_DEF_PKIStatus_tags_1[0]), /* 1 */
	asn_DEF_PKIStatus_tags_1,	/* Same as above */
	sizeof(asn_DEF_PKIStatus_tags_1)
		/sizeof(asn_DEF_PKIStatus_tags_1[0]), /* 1 */
