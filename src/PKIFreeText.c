...
static ber_tlv_tag_t asn_DEF_PKIFreeText_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_PKIFreeText = {
	"PKIFreeText",
	"PKIFreeText",
	SEQUENCE_OF_free,
	SEQUENCE_OF_print,
	...
	asn_DEF_PKIFreeText_tags_1,
	sizeof(asn_DEF_PKIFreeText_tags_1)
		/sizeof(asn_DEF_PKIFreeText_tags_1[0]), /* 1 */
	asn_DEF_PKIFreeText_tags_1,	/* Same as above */
	sizeof(asn_DEF_PKIFreeText_tags_1)
		/sizeof(asn_DEF_PKIFreeText_tags_1[0]), /* 1 */
