...
static asn_TYPE_tag2member_t asn_MAP_NoticeReference_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (12 << 2)), 0, 0, 0 }, /* utf8String at 1457 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 1, 0, 0 }, /* noticeNumbers at 1451 */
    { (ASN_TAG_CLASS_UNIVERSAL | (22 << 2)), 0, 0, 0 }, /* ia5String at 1454 */
    { (ASN_TAG_CLASS_UNIVERSAL | (26 << 2)), 0, 0, 0 }, /* visibleString at 1455 */
    { (ASN_TAG_CLASS_UNIVERSAL | (30 << 2)), 0, 0, 0 } /* bmpString at 1456 */
};
