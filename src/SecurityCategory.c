...
static asn_TYPE_member_t asn_MBR_SecurityCategory_1[] = {
...
static ber_tlv_tag_t asn_DEF_SecurityCategory_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_SecurityCategory_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* type at 2225 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* value at 2226 */
};
static asn_SEQUENCE_specifics_t asn_SPC_SecurityCategory_specs_1 = {
