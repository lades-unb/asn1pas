...
static asn_INTEGER_enum_map_t asn_MAP_OCSPResponseStatus_value2enum_1[] = {
	{ 0,	10,	"successful" },
...
static unsigned int asn_MAP_OCSPResponseStatus_enum2value_1[] = {
	2,	/* internalError(2) */
...
static ber_tlv_tag_t asn_DEF_OCSPResponseStatus_tags_1[] = {
