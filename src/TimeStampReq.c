...
static asn_TYPE_tag2member_t asn_MAP_TimeStampReq_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (1 << 2)), 4, 0, 0 }, /* certReq at 1254 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 0, 0, 1 }, /* version at 1248 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 3, -1, 0 }, /* nonce at 1253 */
    { (ASN_TAG_CLASS_UNIVERSAL | (6 << 2)), 2, 0, 0 }, /* reqPolicy at 1252 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 1, 0, 0 }, /* messageImprint at 1249 */
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 5, 0, 0 } /* extensions at 1255 */
};
